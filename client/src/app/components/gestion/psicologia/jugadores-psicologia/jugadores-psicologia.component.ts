...
@Component({
  selector: 'app-jugadores-psicologia',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-psicologia.component.html',
  styleUrl: './jugadores-psicologia.component.css',
})
export class JugadoresPsicologiaComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
