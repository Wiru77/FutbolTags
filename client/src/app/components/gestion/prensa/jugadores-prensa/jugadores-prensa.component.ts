...
@Component({
  selector: 'app-jugadores-prensa',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-prensa.component.html',
  styleUrl: './jugadores-prensa.component.css',
})
export class JugadoresPrensaComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
  ...
  irADetalleJugador(jugadorId: string) {
    this.router.navigate(['/panel/gestion/prensa', this.equipoId, jugadorId]);
  }
}
