...
@Component({
  selector: 'app-jugadores-porteros',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-porteros.component.html',
  styleUrl: './jugadores-porteros.component.css',
})
export class JugadoresPorterosComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
  ...
  irADetalleJugador(jugadorId: string) {
    this.router.navigate(['/panel/gestion/porteros', this.equipoId, jugadorId]);
  }
}
