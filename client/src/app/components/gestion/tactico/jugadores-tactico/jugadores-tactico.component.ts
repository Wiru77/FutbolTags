...
@Component({
  selector: 'app-jugadores-tactico',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-tactico.component.html',
  styleUrl: './jugadores-tactico.component.css',
})
export class JugadoresTacticoComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
  ...
  irADetalleJugador(jugadorId: string) {
    this.router.navigate(['/panel/gestion/tactico', this.equipoId, jugadorId]);
  }
}
