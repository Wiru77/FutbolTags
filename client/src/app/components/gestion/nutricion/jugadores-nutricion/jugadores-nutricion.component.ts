...
@Component({
  selector: 'app-jugadores-nutricion',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-nutricion.component.html',
  styleUrl: './jugadores-nutricion.component.css',
})
export class JugadoresNutricionComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
