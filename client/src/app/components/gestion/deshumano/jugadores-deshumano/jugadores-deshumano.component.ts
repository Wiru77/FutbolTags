...
@Component({
  selector: 'app-jugadores-deshumano',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-deshumano.component.html',
  styleUrl: './jugadores-deshumano.component.css',
})
export class JugadoresDeshumanoComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
