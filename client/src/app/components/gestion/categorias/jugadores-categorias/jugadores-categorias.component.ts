...
@Component({
  selector: 'app-jugadores-categorias',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-categorias.component.html',
  styleUrl: './jugadores-categorias.component.css',
})
export class JugadoresCategoriasComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
