...
@Component({
  selector: 'app-jugadores-casaclub',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-casaclub.component.html',
  styleUrl: './jugadores-casaclub.component.css',
})
export class JugadoresCasaclubComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
  ...
  irADetalleJugador(jugadorId: string) {
    this.router.navigate(['/panel/gestion/casaclub', this.equipoId, jugadorId]);
  }
}
