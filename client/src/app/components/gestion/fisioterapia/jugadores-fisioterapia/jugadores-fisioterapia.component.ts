...
@Component({
  selector: 'app-jugadores-fisioterapia',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-fisioterapia.component.html',
  styleUrl: './jugadores-fisioterapia.component.css',
})
export class JugadoresFisioterapiaComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
