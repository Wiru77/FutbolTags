...
@Component({
  selector: 'app-jugadores-secretecnica',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-secretecnica.component.html',
  styleUrl: './jugadores-secretecnica.component.css',
})
export class JugadoresSecretecnicaComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
