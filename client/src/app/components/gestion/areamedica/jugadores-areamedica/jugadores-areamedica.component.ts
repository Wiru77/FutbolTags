...
@Component({
  selector: 'app-jugadores-areamedica',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-areamedica.component.html',
  styleUrl: './jugadores-areamedica.component.css',
})
export class JugadoresAreamedicaComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
