...
@Component({
  selector: 'app-jugadores-prepfisica',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-prepfisica.component.html',
  styleUrl: './jugadores-prepfisica.component.css',
})
export class JugadoresPrepfisicaComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
