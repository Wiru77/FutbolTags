...
@Component({
  selector: 'app-jugadores-administracion',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-administracion.component.html',
  styleUrl: './jugadores-administracion.component.css',
})
export class JugadoresAdministracionComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
