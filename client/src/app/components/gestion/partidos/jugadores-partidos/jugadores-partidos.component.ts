...
@Component({
  selector: 'app-jugadores-partidos',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-partidos.component.html',
  styleUrl: './jugadores-partidos.component.css',
})
export class JugadoresPartidosComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
  ...
  irADetalleJugador(jugadorId: string) {
    this.router.navigate(['/panel/gestion/partidos', this.equipoId, jugadorId]);
  }
}
