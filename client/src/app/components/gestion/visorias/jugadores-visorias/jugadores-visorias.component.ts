...
@Component({
  selector: 'app-jugadores-visorias',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-visorias.component.html',
  styleUrl: './jugadores-visorias.component.css',
})
export class JugadoresVisoriasComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
  ...
  irADetalleJugador(jugadorId: string) {
    this.router.navigate(['/panel/gestion/visorias', this.equipoId, jugadorId]);
  }
}
