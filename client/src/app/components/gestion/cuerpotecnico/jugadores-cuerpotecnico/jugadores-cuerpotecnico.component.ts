...
@Component({
  selector: 'app-jugadores-cuerpotecnico',
  standalone: true,
  imports: [RouterModule, NavComponent, CommonModule],
  templateUrl: './jugadores-cuerpotecnico.component.html',
  styleUrl: './jugadores-cuerpotecnico.component.css',
})
export class JugadoresCuerpotecnicoComponent implements OnInit {
  equipoId: string = '';
  equipo: any = null;
  jugadores: any = null;
  token: any;
