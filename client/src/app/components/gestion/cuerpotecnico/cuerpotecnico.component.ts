...
@Component({
  selector: 'app-cuerpotecnico',
  standalone: true,
  imports: [FormsModule, CommonModule, NavComponent, RouterModule],
  templateUrl: './cuerpotecnico.component.html',
  styleUrl: './cuerpotecnico.component.css',
})
export class CuerpotecnicoComponent implements OnInit {
  ...
  irADetalleEquipo(id: string) {
    this.router.navigate(['/panel/gestion/cuerpotecnico/', id]);
  }
}
